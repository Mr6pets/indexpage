...
const allSitesData = [
  ...
  {id: 5, name: 'Online Interface Full', description: '在线接口（完整版）', url: 'https://guluwater.com/onlineinterfacefull/', icon: '🧩', category_id: 1, click_count: 323, sort_order: 5, status: 'active'},
  {id: 6, name: 'Lite Image Previewer', description: '轻量图像预览器', url: 'https://guluwater.com/liteimagepreviewer/', icon: '🖼️', category_id: 1, click_count: 101, sort_order: 6, status: 'active'},
  {id: 7, name: 'Papercraft', description: '纸艺工具', url: 'https://guluwater.com/papercraft/', icon: '✂️', category_id: 1, click_count: 867, sort_order: 7, status: 'active'},
  {id: 8, name: 'Mock Data Generator', description: '智能数据模拟生成器', url: 'https://guluwater.com/mockdatagenerator/', icon: '🔄', category_id: 1, click_count: 737, sort_order: 8, status: 'active'},
